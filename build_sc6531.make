...
HOSTCC = cc
NM = nm
SDK_SRCS = $(wildcard ../sdklib/*.c)
SDK_OBJS = $(patsubst ../sdklib/%.c, $(OBJDIR)/app/sdklib/%.o, $(SDK_SRCS))
APP_OBJS1 += $(SDK_OBJS)
...
CFLAGS += -I. -I../sdklib -I../sdklib/include
ifdef SYSROOT
...
$(OBJDIR)/app/sdklib/%.o: ../sdklib/%.c | objdir
	@mkdir -p $(dir $@)
	$(call compile_cc,$(APP_CFLAGS))
